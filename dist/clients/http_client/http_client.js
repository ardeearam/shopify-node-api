            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                            ...
                            if (data) {
                                switch (type) {
                                    ...
                                    case types_1.DataType.URLEncoded:
                                        body = typeof data === 'string' ? data : querystring_1.default.stringify(data);
                                        break;
                        ...
                        queryString = params.query ? "?" + querystring_1.default.stringify(params.query) : '';
                    ...
                    case 4:
                        ...
                        if (error_1 instanceof ShopifyErrors.HttpThrottlingError && error_1.retryAfter) {
                                ...
                                case 1:
                                    ...
                                    if (response.ok) {
                                        if (response.headers && response.headers.has('X-Shopify-API-Deprecated-Reason')) {
                                            ...
                                            depHash = crypto_1.default.createHash('md5').update(JSON.stringify(deprecation)).digest('hex');
                                            if (!Object.keys(this.LOGGED_DEPRECATIONS).includes(depHash) ||
                                                ...
                                                if (context_1.Context.LOG_FILE) {
                                                    ...
                                                    fs_1.default.writeFileSync(context_1.Context.LOG_FILE, log, { flag: 'a', encoding: 'utf-8' });
                                                }
                                                else {
